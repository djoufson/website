        ...
        {headings.length >= 2 && (
          <nav className="mb-8 p-4 rounded-lg bg-muted/50 border">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-sm font-medium">{t('tableOfContents')}</h2>
            </div>
...
export async function generateMetadata({
  ...
  const localizedUrl = locale === "fr" ? `${baseUrl}/fr/blog/${slug}` : `${baseUrl}/blog/${slug}`;
  ...
  return {
    ...
    alternates: {
      canonical: `/blog/${slug}`,
      languages: { en: `/blog/${slug}`, fr: `/fr/blog/${slug}` },
    },
  };
}
