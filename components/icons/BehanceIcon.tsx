...
/**
 * Behance glyph — lucide-react ships no brand icon for Behance, so this mirrors
 * the lucide icon API (a `size` prop plus spreadable SVG props) and fills with
 * `currentColor` to inherit the surrounding text color. Path from Simple Icons.
 */
