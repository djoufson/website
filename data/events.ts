...
export const speakingAndEvents: Event[] = [
  {
    id: 1,
    title: ".NET Conf 2025",
    role: "Organizer",
    shortDescription:
      "Local edition of .NET Conf featuring .NET 10 and the latest ecosystem updates",
    fullDescription:
      "Organized the .NET Conf 2025 local edition at Serena Hotel Douala, continuing our tradition of bringing world-class .NET content to Cameroon's developer community. The conference explored .NET 10, the latest advancements in the .NET ecosystem, and provided hands-on learning experiences. Developers gathered for a full day of learning, networking, and celebrating the vibrant .NET community in Cameroon.",
    year: "2025",
  ...
  },
  {
    ...
    links: [{ label: "Event Website", url: "https://citscm.com" }],
  },
  {
    id: 2,
    title: ".NET Conf 2024",
    role: "Organizer",
    shortDescription:
      "Local edition of the global .NET Conf focusing on .NET 9 and Aspire",
    fullDescription:
      "Organized the local .NET Conf 2024 event in Douala, bringing the global .NET conference experience to Cameroon. The event showcased the latest features in .NET 9 and explored .NET Aspire, Microsoft's opinionated stack for building cloud-native applications. Developers gathered to learn about the newest innovations in the .NET ecosystem and how to leverage them in their projects.",
    year: "2024",
  ...
  },
  {
    ...
    links: [{ label: "Visit .NET Cameroon", url: "https://dotnet.cm" }],
  },
];
